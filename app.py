...
EVENTS = [
  ...
  # --- 5x5 籃球 ---
  {"d": "9/20 (日)", "s": "五人制籃球 (5x5)", "t": "13:30 - 21:00", "loc": "愛知國際競技場", "focus": "男籃/女籃 分組預賽 首戰亮相", "athlete": "中華男籃代表隊 🏀"},
  {"d": "9/22 (二)", "s": "五人制籃球 (5x5)", "t": "15:00 - 21:00", "loc": "愛知國際競技場", "focus": "男女籃分組預賽 第二戰", "athlete": "中華男籃代表隊 🏀"},
  {"d": "9/24 (四)", "s": "五人制籃球 (5x5)", "t": "13:30 - 21:00", "loc": "愛知國際競技場", "focus": "分組預賽 關鍵卡位戰", "athlete": "中華代表隊 🏀"},
  {"d": "9/26 (六)", "s": "五人制籃球 (5x5) 🥇", "t": "16:00 - 21:30", "loc": "愛知國際競技場", "focus": "🔥 亞運男籃八強/準決賽 高張力激戰", "athlete": "中華男籃主力群 🏀"},
  ...
  {"d": "9/25 (五)", "s": "棒球 (BBL15/16)", "t": "18:30 - 21:30", "loc": "岡崎中央綜合公園棒球場", "focus": "🔥 超級循環賽 Super Round (爭金牌戰門票)", "athlete": "林昱珉 ⚾ 領銜四強主投"},
  {"d": "9/26 (六)", "s": "棒球 (BBL19/20)", "t": "18:30 - 21:30", "loc": "豐橋市立棒球場", "focus": "🔥 超級循環賽次日 (鎖定決賽名額)", "athlete": "中華隊 (林昱珉坐鎮) ⚾"},
  {"d": "9/27 (日)", "s": "棒球 (BBL22) 🥇", "t": "18:30 - 22:30", "loc": "豐橋市立棒球場", "focus": "🔥 亞運棒球金牌大決戰 暨頒獎典禮！", "athlete": "林昱珉 ⚾ 冠軍戰王牌登板！"},

  # --- 體操 ---
  {"d": "9/24 (四)", "s": "競技體操 (GYM05) 🥇", "t": "17:00 - 21:35", "loc": "名古屋綜合體育館", "focus": "🔥 李智凱鞍馬決賽衝金日！完美落地爭金！", "athlete": "李智凱 🤸‍♂️ 鞍馬爭金"},

  # --- 柔道 ---
  {"d": "9/30 (三)", "s": "柔道 (JUD02) 🥇", "t": "17:00 - 19:30", "loc": "愛知國際競技場", "focus": "🔥 楊勇緯男子 60kg 金牌衛冕大決賽！", "athlete": "楊勇緯 🥋 柔道男神衝金"},
  {"d": "10/1 (四)", "s": "柔道 (JUD04) 🥇", "t": "17:00 - 19:30", "loc": "愛知國際競技場", "focus": "🔥 連珍羚女子 57kg 衛冕衝金！", "athlete": "連珍羚 🥋 柔道女王衛冕"},
  {"d": "10/3 (六)", "s": "柔道 (JUD08) 🥇", "t": "17:00 - 19:30", "loc": "愛知國際競技場", "focus": "🔥 男女混合團體金牌大決賽", "athlete": "中華柔道男女代表隊 🥋"},
  ...
  # --- 攀岩 ---
  {"d": "9/29 (二)", "s": "運動攀登 (CLB01)", "t": "10:00 - 13:15", "loc": "名古屋國際展示場", "focus": "男子抱石準決賽 / 速度資格賽", "athlete": "伍鵬 🧗 速度攀登"},
  {"d": "9/30 (三)", "s": "運動攀登 (CLB02)", "t": "10:00 - 13:15", "loc": "名古屋國際展示場", "focus": "男子速度攀岩預賽", "athlete": "伍鵬 🧗 速度預賽"},
  {"d": "10/1 (四)", "s": "運動攀登 (CLB04) 🥇", "t": "18:00 - 21:05", "loc": "名古屋國際展示場", "focus": "🔥 伍鵬男子速度攀岩金牌大決戰！", "athlete": "伍鵬 🧗 4秒台飛人"},

  # --- 拳擊 ---
  {"d": "10/2 (五)", "s": "拳擊 (BOX20) 🥇", "t": "17:30 - 19:45", "loc": "西尾市體育館", "focus": "🔥 黃筱雯女子 54kg 金牌衝刺戰！", "athlete": "黃筱雯 🥊 拳擊衝金"},

  # --- 霹靂舞 ---
  {"d": "10/2 (五)", "s": "霹靂舞 (BKG01)", "t": "下午至晚間", "loc": "Aichi Sky Expo", "focus": "🔥 孫振 vs. Shigekix 台日頂尖十六強資格戰！", "athlete": "孫振 vs. Shigekix 🕺 Breaking"},
  {"d": "10/3 (六)", "s": "霹靂舞 (BKG02) 🥇", "t": "晚間", "loc": "Aichi Sky Expo", "focus": "🔥 孫振 ＆ Shigekix 終極金牌大決戰！", "athlete": "孫振 vs. Shigekix 🕺🥇 金牌大決鬥"}
]

def make_flex_bubble(item):
    # 進行安全網址編碼，確保空格、中文與特殊符號符合 URI 規範
    ...
    with ApiClient(configuration) as api_client:
        ...
        if matches:
            ...
            bot.reply_message(
                ReplyMessageRequest(
                    reply_token=event.reply_token,
                    messages=[TextMessage(text="查無此賽程！\n試試輸入：籃球、鄒子羲、林昱珉、棒球、孫振、楊勇緯、9/25，或點選下方選單開啟完整 App。")]
                )
            )
